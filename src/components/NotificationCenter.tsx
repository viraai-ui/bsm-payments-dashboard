...
export function NotificationCenter(){
 ...
 async function load(){const r=await fetch('/api/payments/notifications',{cache:'no-store'});if(!r.ok)return;const j=await r.json();setItems(j.data.notifications);setUnread(j.data.unreadCount)}
